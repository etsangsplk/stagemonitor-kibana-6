...
export default function callTreeController($scope, $element, $timeout) {
  $scope.callTreeParsed = JSON.parse($scope.source);
  $scope.callTree = [];
  processCallTree($scope.callTree, [$scope.callTreeParsed], null, 1, $scope.callTreeParsed.executionTime);
